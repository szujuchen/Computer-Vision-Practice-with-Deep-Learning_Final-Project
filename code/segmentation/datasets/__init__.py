...
from .data_loader import SegVGDataset, CustomizedSegVGDataset, TestSegVGDataset
...
def make_transforms(args, image_set, is_onestage=False):
    ...
    if image_set in ['val', 'test', 'testA', 'testB', 'valid']:
        return T.Compose([
...
def build_testdataset(args):
    return TestSegVGDataset(img_path=args.img_path, 
                        query=args.query,
