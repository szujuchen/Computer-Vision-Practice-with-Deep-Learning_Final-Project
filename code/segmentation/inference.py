...
from datasets import build_testdataset
from engine import inference


def get_seg_args_parser():
    ...
    # Dataset parameters
    parser.add_argument('--img_path', type=str, required=False, help='query image path')
    parser.add_argument('--query', type=str, required=False, help='query object')
    ...
    # dataset parameters
    parser.add_argument('--output_dir', default='./outputimg',
                        help='path where to save, empty for no saving')
    parser.add_argument('--device', default='cuda',
                        help='device to use for training / testing')
    parser.add_argument('--seed', default=13, type=int)
    parser.add_argument('--resume', default='', help='resume from checkpoint')
    parser.add_argument('--detr_model', default='/tmp2/b10705005/cvpdlfinal/SegVG/checkpoints/detr-r101-referit.pth', type=str, help='detr model')
...
def test_seg(args):
    ...
    # build dataset
    dataset_test = build_testdataset(args)
    ...
    #     with (output_dir / "inference_log.txt").open("w") as f:
    #         f.write(str(args) + "\n")
    
    start_time = time.time()
    
    
    output_seg = inference(args, model, data_loader_test, device)
    ...
    #     '%s_segresult: '%args.img_path: output_path,
    # }
    # print(log_stats)
    # if args.output_dir and utils.is_main_process():
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('SegVG inference script', parents=[get_seg_args_parser()])
