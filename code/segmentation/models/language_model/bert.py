...
class BERT(nn.Module):
    def __init__(self, name: str, train_bert: bool, hidden_dim: int, max_len: int, enc_num):
        ...
        self.bert = BertModel.from_pretrained(name, cache_dir="/tmp2/b10705005/cache/hf")
...
class CustomBertModelLayers(BertModel):
    def __init__(self, config):
        ...
        self.num_channels = 768
        self.load_state_dict(BertModel.from_pretrained("bert-base-uncased", cache_dir="/tmp2/b10705005/cache/hf").state_dict())
...
def build_bert(args):
    bert = CustomBertModelLayers(config = BertConfig.from_pretrained("bert-base-uncased", cache_dir="/tmp2/b10705005/cache/hf"))
    return bert